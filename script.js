...
if (target) {
  ...
  // On attend que les animations CSS de chargement soient finies (0.47s + 0.5s ≈ 1s)
  setTimeout(() => {
    let i = 0;
...
if (email) {
  email.addEventListener("click", (e) => {
    e.preventDefault(); // empêche l'ouverture du client mail
...
if (tel) {
  tel.addEventListener("click", (e) => {
    e.preventDefault(); // empêche l'appel
